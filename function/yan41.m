...
P = P;        % 3×1 或 1×3 向量，来自你的 viewfieldPyrCuboid 输出
n = n'; % 3×1 单位法向量
...
plot3(I2(1),I2(2),I2(3),'ro','MarkerSize',8,'LineWidth',2);
plot3(I3(1),I3(2),I3(3),'ro','MarkerSize',8,'LineWidth',2);
plot3(I4(1),I4(2),I4(3),'ro','MarkerSize',8,'LineWidth',2);
text(0.95*I1(1),0.95*I1(2),0.95*I1(3),'J_1', 'Interpreter', 'tex');
text(0.95*I2(1),0.95*I2(2),0.95*I2(3),'J_2', 'Interpreter', 'tex');
text(0.95*I3(1),0.95*I3(2),0.95*I3(3),'J_3', 'Interpreter', 'tex');
text(0.95*I4(1),0.95*I4(2),0.95*I4(3),'J_4', 'Interpreter', 'tex');
plot3(P(1),P(2),P(3),'ro','MarkerSize',8,'LineWidth',2);
% plot3(P(1),P(2),centroid(3),'ro','MarkerSize',8,'LineWidth',2);
quiver3(P(1),P(2),P(3),- n(1),-n(2),-n(3), 30, 'r', 'LineWidth',2);
...
% text(centroid(1),centroid(2),centroid(3),'  O','FontSize',12,'Color','r');
...
plot3([P(1), I1(1)], [P(2), I1(2)], [P(3), I1(3)], 'b-');
plot3([P(1), I2(1)], [P(2), I2(2)], [P(3), I2(3)], 'b-');
plot3([P(1), I3(1)], [P(2), I3(2)], [P(3), I3(3)], 'b-');
plot3([P(1), I4(1)], [P(2), I4(2)], [P(3), I4(3)], 'b-');
% 
...
% plot3([P(1), P(1)], [P(2), P(2)], [P(3), P(3)-5], 'b-');
plot3([P(1),3.441], [P(2),34.08], [P(3)-5, 53.71], 'b-');
plot3([I4(1), I1(1)], [I4(2), I1(2)], [I4(3), I1(3)], 'r-');
plot3([I1(1), I2(1)], [I1(2), I2(2)], [I1(3), I2(3)], 'r-');
plot3([I4(1), I3(1)], [I4(2), I3(2)], [I4(3), I3(3)], 'r-');
plot3([I2(1), I3(1)], [I2(2), I3(2)], [I2(3), I3(3)], 'r-');
...
function visualizeViewField(nearPts, farPts)
    hold on;
    patch('Faces', [1 2 3 4], 'Vertices', nearPts, 'FaceColor', 'r', 'FaceAlpha', 0.2);
    patch('Faces', [1 2 3 4], 'Vertices', farPts, 'FaceColor', 'b', 'FaceAlpha', 0.2);
